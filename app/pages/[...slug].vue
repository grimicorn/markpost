<template>
  ...
  >
    ...
    <div style="position: relative; text-align: center; max-width: 540px">
      ...
      <div class="code" style="max-width: 440px; margin: 26px auto 0; text-align: left">
        <div class="code-head">
        ...
        <div class="code-body mono" style="font-size: 13px">
          <span :style="{ color: 'var(--accent)' }">$</span> cat /vault{{ route.path }}<br />
          <span :style="{ color: 'var(--err)' }">cat: no such file or directory</span>
        </div>
      </div>
      <h1 class="h1" style="margin-top: 28px">This page never synced.</h1>
      <p class="lead" style="margin-top: 10px">
        The record you're looking for isn't in the vault. It may have been moved, deleted, or
        never written.
      </p>

...
// in by the user — see MANUAL_SECRET_PROVIDERS).
...
export const MANUAL_SECRET_PROVIDERS = [STRIPE_PROVIDER] as const;
...
// Shared-secret providers are compared by equality (never HMAC'd), so unlike
// GitHub/Stripe's HMAC secret they never need to be read back in plaintext —
// only a hash has to be stored. See hashSharedSecret below.
